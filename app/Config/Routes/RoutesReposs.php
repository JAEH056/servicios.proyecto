...
/// ----------- DRPSS Controllers ------------
use App\Controllers\Reposs\MenusDRPSS\ListaResidentes;
...
$routes->group('usuario', ['filter' => 'rbac:default', 'filter-params' => 'default'], function ($routes) {
    ...
    $routes->get('residentes/home',         [HomeResidente::class, 'index'], ['filter' => 'rbac', 'filter-params' => 'default']);
...
$routes->group('usuario', ['filter' => 'rbac:default'], function ($routes) {
    $routes->get('drpss/residentes',   [ListaResidentes::class, 'index']);
