...
class RoleFilter implements FilterInterface
{
    public function before(RequestInterface $request, $arguments = null)
    {
        ...
        // Revisa si la ruta envia el permiso requerido
        if (!$requiredPermission) {
            // Se maneja el caso en el que el permiso no se envia
            return redirect()->to('/acceso-denegado',)->with('message', 'No se encontro un permiso antes del filtro con:"'. $requiredPermission . '"');
        }
